...
<html>
	...
	<?php
		$db =  new Database();
           ...
           if($foodItemName == '' || $foodQuantity == '' || $foodReservationDate == ''){
               $error = "Field Must not be empty!";
           }else{
               
            $queryFoodReservation = "INSERT INTO `foodreservation`( `foodName`, `foodQuantity`, `foodReservationDate`) VALUES (' $foodItemName','$foodQuantity','$foodReservationDate')";
            $create = $db->insertFoodReservation($queryFoodReservation);
           }
       } 
	?>
	<body>
                ...
                <div class="foodReservationMsg">
                    ...
                    <?php
                       if(isset($_GET['msgFoodReservation'])){
                          echo "<span style='color:green';margin-left:300px;>".$_GET['msgFoodReservation']."</span>";
                       } 
                    ?>
                </div>
				<div class="foodReservationSubContent">
					<p>Food Reservation Entry Form</p>
					<div class="foodReservationSubMenu">
					  <form method="post" action="foodReservationRegistration.php">
							<table>
								<tr>
									<td>
										<input id="myInput" type="text" name="foodItemName" placeholder="Food Name" class="form-control"> 
									</td>
								</tr>
								<tr>
									<td>	
										<input id="myInput" type="text" name="foodQuantity" placeholder="Food Quantity" class="form-control"> 
									</td>
								</tr>
								<tr>
									<td>
										<div class="input-group date form_datetime col-md-5" data-date="1979-09-16T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
										<input id="myInput" class="form-control" size="16" type="text" readonly name="foodReservationDate" Placeholder="Date and Time">
