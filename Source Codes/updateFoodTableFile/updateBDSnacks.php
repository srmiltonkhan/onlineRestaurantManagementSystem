...
<?php 
	    $id = $_GET['id']; 
		$db = new Database();
		$query = "SELECT * FROM bdsnacks WHERE BDSnacksId= $id"; //sql Command language
		...
		if(isset($_POST['update'])){
           ...
           if($foodItemName == '' || $foodItemPrice == ''){
             ...
             $updateQuery = "UPDATE `bdsnacks` SET 
...
?>
		...
		<?php 
			if(isset($_POST['delete'])){
				$deleteQuery = "DELETE FROM bdsnacks WHERE BDSnacksId=$id";
			...
			<div class = "sub-menu">
				...
				<div class="foodMenuContent">
					...
					<div class="foodSubMenu">
					  <form method="post" action="updateBDSnacks.php?id=<?php echo $id;?>">
						<table>
							<tr>
								<td></td>
							</tr>
