...
<?php 
	    $id = $_GET['id']; 
		$db = new Database();
		$query = "SELECT * FROM bdmeat WHERE bdMeatId= $id"; //sql Command language
...
?>
		...
		<?php 
			if(isset($_POST['delete'])){
				$deleteQuery = "DELETE FROM bdmeat WHERE bdMeatId=$id";
			...
			<div class = "sub-menu">
				...
				<div class="foodMenuContent">
					...
					<div class="foodSubMenu">
					  <form method="post" action="updateBDMeat.php?id=<?php echo $id;?>">
						<table>
							<tr>
								<td></td>
							</tr>
