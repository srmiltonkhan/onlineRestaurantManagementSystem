...
<?php 
	    $id = $_GET['id']; 
		$db = new Database();
		$query = "SELECT * FROM chssalad WHERE chSaladId= $id"; //sql Command language
		...
		if(isset($_POST['update'])){
           ...
           if($foodItemName == '' || $foodItemPrice == ''){
             ...
             $updateQuery = "UPDATE `chssalad` SET 
...
?>
		...
		<?php 
			if(isset($_POST['delete'])){
				$deleteQuery = "DELETE FROM chssalad WHERE chSaladId=$id";
			...
			<div class = "sub-menu">
				...
				<div class="foodMenuContent">
					...
					<div class="foodSubMenu">
					  <form method="post" action="updateCHSalad.php?id=<?php echo $id;?>">
						<table>
							<tr>
								<td></td>
							</tr>
