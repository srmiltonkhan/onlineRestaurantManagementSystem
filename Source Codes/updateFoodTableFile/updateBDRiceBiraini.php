...
<?php 
	    $id = $_GET['id']; 
		$db = new Database();
		$query = "SELECT * FROM bdrice_biriani WHERE bdRiceBirianiId= $id"; //sql Command language
		...
		if(isset($_POST['update'])){
           ...
           if($foodItemName == '' || $foodItemPrice == ''){
             ...
             $updateQuery = "UPDATE `bdrice_biriani` SET 
			 
			 `foodItemName`= '$foodItemName',
			 `foodItemPrice`= '$foodItemPrice' 
			 WHERE `bdRiceBirianiId`= '$id'";
...
?>
		...
		<?php 
			if(isset($_POST['delete'])){
				$deleteQuery = "DELETE FROM bdrice_biriani WHERE bdRiceBirianiId=$id";
		...
		<div class="main-content">
			...
			<div class = "sub-menu">
				...
				<div class="foodMenuContent">
					<p>Bangladeshi Rice Biriani</p>
					<div class="foodSubMenu">
					  <form method="post" action="updateBDRiceBiraini.php?id=<?php echo $id;?>">
						<table>
							<tr>
								<td></td>
							</tr>
