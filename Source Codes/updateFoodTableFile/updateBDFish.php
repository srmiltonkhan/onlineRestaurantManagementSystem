...
<?php 
	    $id = $_GET['id']; 
		$db = new Database();
		$query = "SELECT * FROM bdfish WHERE bdFishId= $id"; //sql Command language
...
?>
		...
		<?php 
			if(isset($_POST['delete'])){
				$deleteQuery = "DELETE FROM bdfish WHERE bdFishId=$id";
			...
			<div class = "sub-menu">
				...
				<div class="foodMenuContent">
					...
					<div class="foodSubMenu">
					  <form method="post" action="updateBDFish.php?id=<?php echo $id;?>">
						<table>
							<tr>
								<td></td>
							</tr>
