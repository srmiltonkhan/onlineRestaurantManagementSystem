...
<?php 
	    $id = $_GET['id']; 
		$db = new Database();
		$query = "SELECT * FROM jsfishseafood WHERE JsfishseafoodId= $id"; //sql Command language
		...
		if(isset($_POST['update'])){
           ...
           if($foodItemName == '' || $foodItemPrice == ''){
             ...
             $updateQuery = "UPDATE `jsfishseafood` SET 
			 
			 `foodItemName`= '$foodItemName',
			 `foodItemPrice`= '$foodItemPrice' 
			 WHERE `JsfishseafoodId`= '$id'";
...
?>
		...
		<?php 
			if(isset($_POST['delete'])){
				$deleteQuery = "DELETE FROM jsfishseafood WHERE JsfishseafoodId=$id";
			...
			<div class = "sub-menu">
				...
				<div class="foodMenuContent">
					...
					<div class="foodSubMenu">
					  <form method="post" action="updateJPFishSeaFood.php?id=<?php echo $id;?>">
						<table>
							<tr>
								<td></td>
							</tr>
