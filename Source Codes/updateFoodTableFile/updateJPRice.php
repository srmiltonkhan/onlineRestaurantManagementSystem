...
<?php 
	    $id = $_GET['id']; 
		$db = new Database();
		$query = "SELECT * FROM jprice WHERE jpRiceId= $id"; //sql Command language
...
?>
		...
		<?php 
			if(isset($_POST['delete'])){
				$deleteQuery = "DELETE FROM jprice WHERE jpRiceId=$id";
			...
			<div class = "sub-menu">
				...
				<div class="foodMenuContent">
					...
					<div class="foodSubMenu">
					  <form method="post" action="updateJPRice.php?id=<?php echo $id;?>">
						<table>
							<tr>
								<td></td>
							</tr>
