...
<?php 
	    $id = $_GET['id']; 
		$db = new Database();
		$query = "SELECT * FROM chsnoodles WHERE chsNoodlesId= $id"; //sql Command language
		...
		if(isset($_POST['update'])){
           ...
           if($foodItemName == '' || $foodItemPrice == ''){
             ...
             $updateQuery = "UPDATE `chsnoodles` SET 
			 
			 `foodItemName`= '$foodItemName',
			 `foodItemPrice`= '$foodItemPrice' 
			 WHERE `chsNoodlesId`= '$id'";
...
?>
		...
		<?php 
			if(isset($_POST['delete'])){
				$deleteQuery = "DELETE FROM chsnoodles WHERE chsNoodlesId=$id";
			...
			<div class = "sub-menu">
				...
				<div class="foodMenuContent">
					...
					<div class="foodSubMenu">
					  <form method="post" action="updateCHSNoodles.php?id=<?php echo $id;?>">
						<table>
							<tr>
								<td></td>
							</tr>
