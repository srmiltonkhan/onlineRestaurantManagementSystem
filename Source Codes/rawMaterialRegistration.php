...
<?php
   ...
   if(isset($_POST['submit'])){
           ...
           if($foodItemName == '' || $foodQuantity == '' || $foodCost == '' || $purchaseDate == '' || $buyerName == '' || $sellerName == ''){
            ...
            $queryRawMaterial = "INSERT INTO `rawmaterial`(`foodName`, `foodQuantity`, `foodCost`, `purchaseDate`, `buyerName`, `sellerName`) VALUES ('$foodItemName','$foodQuantity','$foodCost','$purchaseDate',' $buyerName','$sellerName')";
            $create = $db->insertRawMaterial($queryRawMaterial);
           }
       } 
?>
	<body>
		...
		<div class="main-content">
			...
			<div class = "sub-menu">
                <div class="rawMaterialMessage">
                    ...
                    ?>
                    <?php
                       if(isset($_GET['msgRawMaterial'])){
                          echo "<span style='color:green'>".$_GET['msgRawMaterial']."</span>";
                       } 
                    ?>
                </div>
				<div class="rawMaterialMenuContent">
					<p>Raw Material Entry Form</p>
					<div class="rawMaterialSubMenu">
					  <form method="post" action="rawMaterialRegistration.php">
						<table>
							<tr>
								<td></td>
							</tr>
							...
							<tr>
								<td>
									<input id="myInput" type="text" name="foodItemName" placeholder="Material Name"> 
								</td>
							</tr>
							<tr>
								<td>
									<input id="myInput" type="text" name="foodQuantity" placeholder="Material Quantity"> 
								</td>
							</tr>
							<tr>
								<td>
									<input id="myInput" type="text" name="foodCost" placeholder="Food Cost"> 
								</td>
							</tr>
							<tr>
								<td>
									<input id="myInput" type="date" name="purchaseDate" placeholder="Purchase Date"> 
								</td>
							</tr>
							<tr>
								<td>
									<input id="myInput" type="text" name="buyerName" placeholder="Buyer Name"> 
								</td>
							</tr>
							<tr>
								<td>
									<input id="myInput" type="text" name="sellerName" placeholder="Seller Name"> 
								</td>
							</tr>
							<tr>
								<td>
