...
<?php 
	    $id = $_GET['id']; 
		$db = new Database();
		$query = "SELECT * FROM jpnoodles WHERE jpNoodlesId= $id"; //sql Command language
		...
		if(isset($_POST['update'])){
           ...
           if($foodItemName == '' || $foodItemPrice == ''){
             ...
             $updateQuery = "UPDATE `jpnoodles` SET 
			 
			 `foodItemName`= '$foodItemName',
			 `foodItemPrice`= '$foodItemPrice' 
			 WHERE `jpNoodlesId`= '$id'";
...
?>
		...
		<?php 
			if(isset($_POST['delete'])){
				$deleteQuery = "DELETE FROM jpnoodles WHERE jpNoodlesId=$id";
			...
			<div class = "sub-menu">
				...
				<div class="foodMenuContent">
					...
					<div class="foodSubMenu">
					  <form method="post" action="updateJPNoodles.php?id=<?php echo $id;?>">
						<table>
							<tr>
								<td></td>
							</tr>
