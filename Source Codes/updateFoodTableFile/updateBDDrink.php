...
<?php 
	    $id = $_GET['id']; 
		$db = new Database();
		$query = "SELECT * FROM bddrink WHERE bdDrinkId= $id"; //sql Command language
		...
		if(isset($_POST['update'])){
           ...
           if($foodItemName == '' || $foodItemPrice == ''){
             ...
             $updateQuery = "UPDATE `bddrink` SET 
...
?>
		...
		<?php 
			if(isset($_POST['delete'])){
				$deleteQuery = "DELETE FROM bddrink WHERE bdDrinkId=$id";
			...
			<div class = "sub-menu">
				...
				<div class="foodMenuContent">
					...
					<div class="foodSubMenu">
					  <form method="post" action="updateBDDrink.php?id=<?php echo $id;?>">
						<table>
							<tr>
								<td></td>
							</tr>
